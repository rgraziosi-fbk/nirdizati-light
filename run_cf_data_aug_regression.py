...
def run_simple_pipeline(CONF=None, dataset_name=None):
    ...
    if CONF['explanator'] is ExplainerType.DICE_AUGMENTATION.value:
        ...
        if CONF['simulation']:
            ...
            if dataset_name == 'SynLoan' or dataset_name == 'PurchasingExample' or dataset_name == 'Productions' or dataset_name == 'bpic2012_2_start_old' or dataset_name == 'bpic2015_2_start' or dataset_name == 'bpic2015_4_start' or dataset_name == 'sepsis_cases_2_start' or dataset_name == 'sepsis_cases_3_start' or dataset_name=='sepsis_cases_1_start':
        ...
        for prefix in prefix_lengths:
            ...
            updated_train_df_reduced['label'] = best_model.model.predict(drop_columns(updated_train_df_reduced))
            predictive_models_new = [PredictiveModel(REGRESSION_CONF, predictive_model, updated_train_df_reduced, val_df, test_df) for
                                     predictive_model
                                     in
                                     REGRESSION_CONF['predictive_models']]
